...
public class ChatRoomController {
    ...
    public String goChatRoom(Model model, AppAuthentication auth) {
        ResponseUserInfoDto responseUserInfoDto = userService.getUserInfo(auth.getUserId());

        model.addAttribute("list", chatService.findAllRoom());
        model.addAttribute("user", responseUserInfoDto);
    ...
    public String roomDetail(Model model, String roomId, AppAuthentication auth){
        ...
        model.addAttribute("user", userService.getUserInfo(auth.getUserId()));
